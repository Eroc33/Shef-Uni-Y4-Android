 ...
 * =====================
 *
 * NOTE: Copied from the android source and extended to work around a bug where the fastscroller
 * thumb can become too small to interact with
 */
 ...
 */
public class RecyclerViewFastScrollerThumbHack extends ItemDecoration implements OnItemTouchListener {

    //MODIFICATION: the min height of any scroll thumb. 48 is chosen here as that is recommended as
    //              the minimum size for buttons, icons, etc
    static final int MIN_THUMB_HEIGHT = 48;
    ...
    public RecyclerViewFastScrollerThumbHack(RecyclerView recyclerView, StateListDrawable verticalThumbDrawable,
    ...
    void updateScrollPosition(int offsetX, int offsetY) {
        ...
        if (mNeedVerticalScrollbar) {
            ...
            //NOTE: here's our modification
            mVerticalThumbHeight = Math.max(mVerticalThumbHeight, MIN_THUMB_HEIGHT);
        }
